...
> **A multi-agent AI research pipeline that discovers, evaluates, and ranks arXiv papers by their AGI potential — powered by Anthropic Claude and LangGraph.**
...
**Agentic arXiv Creator** is an autonomous research system that uses a team of specialized AI agents to search arXiv for cutting-edge AI/ML papers and evaluate them against a rigorous 10-parameter AGI potential framework. The system produces executive-level reports ranking papers by their contribution to Artificial General Intelligence.
...
- **Intelligent Paper Discovery** — A tool-augmented agent searches arXiv across 5 AI/ML categories (`cs.AI`, `cs.LG`, `cs.CL`, `cs.CV`, `cs.NE`), with automatic deduplication and quality validation.
- **Weighted AGI Evaluation** — Each paper is scored on 10 weighted parameters (novel problem solving, few-shot learning, task transfer, abstract reasoning, and more) to produce a 0–100 AGI potential score.
...
The system will:
1. Parse your query into a search plan
2. Search arXiv for matching papers
3. Evaluate each paper's AGI potential
...
├── research_multi_agent_system.py   # Main pipeline (all agents + graph)
